...
@property (retain) ClientAppInfo* _builderResult;
@end
...
- (id) init {
  if ((self = [super init])) {
    self._builderResult = [[[ClientAppInfo alloc] init] autorelease];
  }
  return self;
}
...
- (ClientAppInfo_Builder*) clear {
  _builderResult = [[[ClientAppInfo alloc] init] autorelease];
  return self;
}
- (ClientAppInfo_Builder*) clone {
  return [ClientAppInfo builderWithPrototype:_builderResult];
}
- (ClientAppInfo*) defaultInstance {
...
- (ClientAppInfo*) buildPartial {
  ClientAppInfo* returnMe = [[_builderResult retain] autorelease];
  self._builderResult = nil;
  return returnMe;
}
