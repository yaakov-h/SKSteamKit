...
@property (retain) CMsgMulti* _builderResult;
@end
...
- (id) init {
  if ((self = [super init])) {
    self._builderResult = [[[CMsgMulti alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CMsgMulti_Builder*) clear {
  _builderResult = [[[CMsgMulti alloc] init] autorelease];
  return self;
}
- (CMsgMulti_Builder*) clone {
  return [CMsgMulti builderWithPrototype:_builderResult];
}
- (CMsgMulti*) defaultInstance {
...
- (CMsgMulti*) buildPartial {
  CMsgMulti* returnMe = [[_builderResult retain] autorelease];
  self._builderResult = nil;
  return returnMe;
}
...
@property (retain) CMsgAuthTicket* _builderResult;
@end
...
- (id) init {
  if ((self = [super init])) {
    self._builderResult = [[[CMsgAuthTicket alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CMsgAuthTicket_Builder*) clear {
  _builderResult = [[[CMsgAuthTicket alloc] init] autorelease];
  return self;
}
- (CMsgAuthTicket_Builder*) clone {
  return [CMsgAuthTicket builderWithPrototype:_builderResult];
}
- (CMsgAuthTicket*) defaultInstance {
...
- (CMsgAuthTicket*) buildPartial {
  CMsgAuthTicket* returnMe = [[_builderResult retain] autorelease];
  self._builderResult = nil;
  return returnMe;
}
...
@property (retain) CCDDBAppDetailCommon* _builderResult;
@end
...
- (id) init {
  if ((self = [super init])) {
    self._builderResult = [[[CCDDBAppDetailCommon alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CCDDBAppDetailCommon_Builder*) clear {
  _builderResult = [[[CCDDBAppDetailCommon alloc] init] autorelease];
  return self;
}
- (CCDDBAppDetailCommon_Builder*) clone {
  return [CCDDBAppDetailCommon builderWithPrototype:_builderResult];
}
- (CCDDBAppDetailCommon*) defaultInstance {
...
- (CCDDBAppDetailCommon*) buildPartial {
  CCDDBAppDetailCommon* returnMe = [[_builderResult retain] autorelease];
  self._builderResult = nil;
  return returnMe;
}
...
@property (retain) CMsgAppRights* _builderResult;
@end
...
- (id) init {
  if ((self = [super init])) {
    self._builderResult = [[[CMsgAppRights alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CMsgAppRights_Builder*) clear {
  _builderResult = [[[CMsgAppRights alloc] init] autorelease];
  return self;
}
- (CMsgAppRights_Builder*) clone {
  return [CMsgAppRights builderWithPrototype:_builderResult];
}
- (CMsgAppRights*) defaultInstance {
...
- (CMsgAppRights*) buildPartial {
  CMsgAppRights* returnMe = [[_builderResult retain] autorelease];
  self._builderResult = nil;
  return returnMe;
}
