...
@property (retain) EncryptedAppTicket* result;
@end
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[EncryptedAppTicket alloc] init] autorelease];
  }
  return self;
}
...
- (EncryptedAppTicket_Builder*) clone {
  return [EncryptedAppTicket builderWithPrototype:result];
}
- (EncryptedAppTicket*) defaultInstance {
...
- (EncryptedAppTicket*) buildPartial {
  EncryptedAppTicket* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
